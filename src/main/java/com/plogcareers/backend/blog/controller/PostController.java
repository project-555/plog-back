...
public class PostController {
    ...
    public ResponseEntity<SResponse> read(@PathVariable Long id) {
...
//    public ResponseEntity<SResponse> update(@PathVariable Long id, @RequestBody PostingUpdateRequest postingUpdateRequest) {
